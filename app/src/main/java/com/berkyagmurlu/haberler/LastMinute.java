...
public class LastMinute extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    String url_goster = "http://10.0.2.2:8080/portal/lastMinuteJson.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycleViewC);
        recyclerView.setHasFixedSize(true);

        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        newsLists = new ArrayList<>();
        mRecAdapter = new NewsAdapter(LastMinute.this, newsLists);
        ...
        mNavigation.setCheckedItem(R.id.nav_lastMınute);
